	...
	<div class="container-fluid gedf-wrapper">
		<div class="row">
				...
				<div class="card">
					...
					<ul class="list-group list-group-flush">
						<div class="home-button">
							<a href='<c:url value="/home"/>'> <i class="fa fa-home"></i> <span>Home</span>
							</a>
						</div>
						<div class="profile-button">
							<a href='<c:url value="/profile"/>'> <i class="fa fa-user"></i> <span>Profile</span>
							</a>
						</div>
			...
			<div class="col-md-6 gedf-main">
				...
				<!--- \\\\\\\Post-->
				<form action="home" method="post" autocomplete="on">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="posts"
									...
									<div class="form-group">
										...
										<textarea class="form-control" id="message" name="content" rows="3"
